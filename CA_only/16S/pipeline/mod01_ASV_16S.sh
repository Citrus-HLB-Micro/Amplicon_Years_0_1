...
#SBATCH --time=7-0:00:00   # walltime
#SBATCH -N 1 -n 1 -c 48
#SBATCH --mem=128gb # memory per CPU core
...
if [ ! -f $BASE.taxonomy.txt ]; then
	amptk taxonomy -f $BASE.dada2.ASV.fa -i $BASE.dada2.asv_table.txt -d 16S
fi
